...
from Models.AVL import AVL  # Importa la clase AVL
from Models.BST import BST  # Importa la clase BST
from Models.Flight import Flight  # Importa la clase Flight para crear nodos
